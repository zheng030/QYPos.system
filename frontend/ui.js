/* ui.js - 介面渲染與事件處理 (v18: 修復商品庫存管理頁面) */
console.log("UI JS v18 Loaded - 介面程式已載入");
...
async function printReceipt(data, isTicket = false) {
    ...
    // 🔥 修改：新增 style 標籤強制列印時靠左對齊，並限制整體寬度 (58mm)
    const styleOverride = `<style>
        @media print {
            /* 限制列印區域寬度 (58mm)，解決長白邊問題 */
            ...
            .receipt-section { 
                padding-left: 30px !important; /* 🔥 內縮 30px 距離 */
                text-align: left !important; 
            }
            .receipt-header, .receipt-info { 
                text-align: left !important; /* 標頭強制靠左 */
            }
