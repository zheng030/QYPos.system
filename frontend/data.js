/* data.js - 系統設定與菜單資料 (v15: 燒烤 Popular 新增五種蔬菜) */
...
const menuData = {
    ...
    "啤酒": [{ name: "百威", price: 120 }, { name: "可樂娜", price: 120 }, { name: "金樽", price: 150 }, { name: "雪山", price: 150 }],
    ...
    "燒烤": {
        ...
        "Popular": [{ name: "米血", price: 25 }, { name: "豆乾", price: 25 }, { name: "小肉豆", price: 25 }, { name: "甜不辣", price: 25 }, { name: "鑫鑫腸", price: 25 }, { name: "糯米腸", price: 25 }, { name: "百頁豆腐", price: 25 }, { name: "豆包", price: 30 }, { name: "肥腸", price: 30 }, { name: "鱈魚丸", price: 30 }, { name: "豬捲蔥", price: 40 }, { name: "豬捲金針菇", price: 40 }, { name: "香腸", price: 40 }, { name: "牛肉串", price: 45 }, { name: "孜然羊肉串", price: 50 }, { name: "香蔥雞腿肉串", price: 55 }, { name: "雞腿", price: 80 }, { name: "四季豆", price: 45 }, { name: "青椒", price: 45 }, { name: "香菇", price: 45 }, { name: "杏包菇", price: 45 }, { name: "櫛瓜", price: 45 }],
        "Chicken": [{ name: "雞脖子", price: 25 }, { name: "雞胗", price: 30 }, { name: "雞心", price: 30 }, { name: "雞翅", price: 30 }, { name: "雞屁股", price: 30 }, { name: "雞皮", price: 35 }, { name: "雞腿捲", price: 45 }, { name: "雞胸肉", price: 40 }, { name: "雞軟骨", price: 65 }, { name: "大熱狗", price: 35 }, { name: "鹹麻吉", price: 35 }, { name: "花生麻吉", price: 35 }],
